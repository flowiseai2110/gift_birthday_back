...
{
    public class ClienteCartillaDetalleMap : IEntityTypeConfiguration<ClienteCartillaDetalle>
    {
        public void Configure(EntityTypeBuilder<ClienteCartillaDetalle> builder)
        {
            // table
            builder.ToTable("cliente_cartilla_detalle", "proceso");

            // key
            builder.HasKey(t => t.cliente_cartilla_detalle_id);

            // properties
            builder.Property(t => t.cliente_cartilla_detalle_id)
                .HasColumnName("i_cliente_cartilla_detalle_id")
            ...
            builder.Property(t => t.referencia_pago)
             .HasColumnName("v_referencia_pago")
